...
newdnsserver = "10.244.137.8"

dnsoption = get(bamurl, "getDHCPClientDeploymentOption", optionparams, header)

dnsoption["value"] = newdnsserver

updated = put(bamurl,"updateDHCPClientDeploymentOption", dnsoption, header)

print(updated)


server = {"id": 100969, "name": "bdds1"}
# deploy to BAM
deployparam = {
                "serverId": 100969,
                "properties": "services=DNS,DHCP|forceDNSFullDeployment=true"
                }
deploy = post(bamurl, "deployServerConfig", deployparam, header)
# sleep(5)
...
def checkstatus(server_id):
    ...
    deploy_status = 0
    statusparam = {"serverId": server_id, "properties": ""}
    ...
    while deploy_status < 2:
        ...
        print("Status Code:", deploy_status)
        sleep(0.5)
